...
import BottonAddCar from './botton-add-car'
  ...
  <div className='product'>
    <div className='product__container-img'>
      <div className='product__container-img-product'>
        <img
          src='https://superfuds-file.s3.us-west-2.amazonaws.com/product/7709296944182_5e55873440167.png'
          alt=''
        />
      </div>
